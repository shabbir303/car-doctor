...
const Footer = () => {
    return (
        <div>
            <footer 
            className="w-full  py-10 px-4 sm:px-6 lg:px-8 mx-auto bg-black text-white bottom-0 ">
  {/* <!-- Grid --> */}
  <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 mb-10">
    <div className="col-span-full hidden lg:col-span-1 lg:block">
      <a className="flex-none text-xl font-semibold dark:text-white" href="#" aria-label="Brand"><img src="../../../logo.svg" alt=""  /></a>
